    ...
    <div className="app-about">
      <div className="left-content">
        <div className="basic-intro">
          ...
          <p>I worked as a Software Engineer Intern at Ayu Health (May - Aug 2023).</p>
          <p>Completed my 12th from Kendriya Vidyalaya Keltron Nagar, Kannur in Computer Science.</p>
        </div>
